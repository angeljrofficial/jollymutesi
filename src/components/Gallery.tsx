...
const galleryImages = [
  { src: 'https://pbs.twimg.com/media/G2reTNjWgAEu4H8?format=jpg&name=orig', alt: 'Miss Rwanda 2016 Crowning', category: 'Pageant' },
  { src: 'https://pbs.twimg.com/media/G1Egn1LXIAA1vwT?format=png&name=orig', alt: 'Motivational Speaking Event', category: 'Speaking' },
  { src: 'https://pbs.twimg.com/media/GqLM1qJW0AANFb_?format=jpg&name=orig', alt: 'Community Service', category: 'Activism' },
  { src: 'https://pbs.twimg.com/media/GhHhg9kXMAA6SyO?format=jpg&name=orig', alt: 'Nutrition Program', category: 'Activism' },
  { src: 'https://pbs.twimg.com/media/GhFIGF-WsAAxp7H?format=jpg&name=orig', alt: 'Youth Workshop', category: 'Speaking' },
  { src: 'https://pbs.twimg.com/media/GftnYNtXkAAyS_y?format=jpg&name=orig', alt: 'Professional Portrait', category: 'Modeling' },
  { src: 'https://pbs.twimg.com/media/GfQZVFKXMAA66e8?format=jpg&name=orig', alt: 'Community Work', category: 'Activism' },
  { src: 'https://pbs.twimg.com/media/Ge06bNyWAAA1RAq?format=jpg&name=orig', alt: 'Youth Empowerment', category: 'Speaking' },
];
